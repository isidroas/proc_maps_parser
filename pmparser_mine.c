...
procmaps_struct* pmparser_next(procmaps_iterator* p_procmaps_it){
  // consumo aun más bajo de memoria seria guardar el stream y hacer parse_line aquí. Esa es la ventaja de los iterators con respecto a los arrays. De lo contrario (por ejemplo si se quiere acceder a todos los elementos a la vez), sería mejor un array y usar realloc.
  // TODO: mirar implementación de getifaddr o alguna otra API que hace uso de linked lists.
  procmaps_struct* res;
